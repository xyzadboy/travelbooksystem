<div>
        ...
        <div class="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div class="col-span-1 md:col-span-1">
                <span class="text-2xl font-bold text-white uppercase tracking-wider">Trans<span class="text-orange-500">Wisata</span></span>
                <p class="mt-4 text-gray-400 leading-relaxed">Solusi transportasi pariwisata terpercaya sejak 2010. Melayani perjalanan ke seluruh Indonesia dengan sepenuh hati.</p>
            </div>
            <div>
                <h4 class="text-lg font-bold mb-6">Navigasi</h4>
                <ul class="space-y-4 text-gray-400">
                    <li><a href="#" class="hover:text-white transition">Kebijakan Sewa</a></li>
                    <li><a href="#" class="hover:text-white transition">Daftar Harga</a></li>
        ...
        <div class="border-t border-gray-800 pt-8 text-center text-gray-500 text-sm">
            <p>&copy; 2024 TransWisata Transport Service. All rights reserved.</p>
        </div>
    </footer>
</div>